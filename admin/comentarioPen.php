...
<body>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                    ...
                    <div class="dropdown-menu dropmio" aria-labelledby="navbarDropdown">
                        ...
                        <a class="dropdown-item disabled" href="#">Comentarios Pendientes</a>
                    ...
                    <div class="card-body" id="formulario">
                        ...
                        <input type="number" id="codigoformulario" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="mensaje" name="mensaje" rows="10" cols="75" readonly></textarea>
                            </div>
                            <script>
                        ...
                        <br>
                        <button class="publicar btn btn-success" type="submit">
    ...
    <script src="./js/funcionesComentarioPen.js"></script>
