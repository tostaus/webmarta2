...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <button class="addFaq navbar-brand tn btn-ttc">
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body" id="formulario">
                        ...
                        <label for="pregunta">Pregunta</label>
                            <input type="text" id="pregunta" class="form-control" required >
                        </div>
                        
                        <div class="form-group">
                        <label for="respuesta">Respuesta</label>
                        <textarea id="respuesta" class="form-control" rows="15" min="25" required ></textarea>
                        </div>
                        <script>
                            ...
                            <button class="publicar btn btn-danger" type="submit">
