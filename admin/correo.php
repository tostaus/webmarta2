...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top">
        <a class="navbar-brand fas fa-envelope" href="#"></a>
        <a class="navbar-brand" href="#"><?php print $printleido;?></a>
        <input type="text" id="leido" value = "<?php echo $leido;?>" hidden>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mx-auto mb-2 mb-md-0">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropmio" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="blog.php">Entradas Blog</a>
            ...
            <!-- TABLA  -->
                ...
                <div class="col-md-6">
                    ...
                    <div class="card-body" id="formulario">
                        ...
                        <textarea id="mensaje" class="form-control" rows="15" min="25" ></textarea>
                        </div>

                        <br>
                        
                        </form>
                        <button class="leido btn btn-danger">
