...
<body>
                    ...
                    <div class="card-body" id="formulario">
                        ...
                        <input type="number" id="codigoformulario" hidden>
                            ...
                            <div class="form-group">
                                ...
                                <textarea id="comentario" name="comentario" rows='80' required></textarea>
                                <textarea id="quitar" hidden></textarea>
                            </div>
                            <script>
                            ...
                            <input type="time" name="hora" id="hora">
                                ...
                                <br>
                                <div class="form-group">
                                <label for="image" id="labelimage">Subir foto (max. 600Kb) .:</label>
    ...
    <script src="./js/funcionesBlog.js"></script>
